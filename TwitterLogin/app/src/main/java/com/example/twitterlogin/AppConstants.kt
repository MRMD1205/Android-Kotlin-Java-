...
const val Twitter_SIGN_IN_CODE: Int = 110
const val CAMERA: Int = 0x50
const val GALLERY_CODE: Int = 5051
const val CAMERA_CODE: Int = 5150
const val REQUEST_CODE: Int = 1111
const val RC_SIGN_IN: Int = 1212
...
const val BASE_URL: String = "" // live
...
const val VERIFY_USER_FRAGMENT = "verify_user_fragment"
const val HOME_COVID_TEST_FRAGMENT = "home_covid_test_fragment"
const val ENTER_NEW_COVID_TEST_FRAGMENT = "enter_new_covid_test_fragment"
const val RECENT_TEST_RESULTS_FRAGMENT = "recent_test_results_fragment"
const val VACCINE_FRAGMENT = "vaccine_fragment"
const val PROFILE_FRAGMENT = "profile_fragment"
const val COVID_ANTI_BODY_FRAGMENT = "profile_fragment"

                    ...
                    override fun intercept(chain: Interceptor.Chain): Response {
                        ...
                        val request: Request =
                            chain.request().newBuilder()
                                .header("Authorization","Bearer " + ValidityApplication.instance.preferenceData?.getValueFromKey(PREF_DEVICE_TOKEN)!!)
...
//                })
        ...
        private fun getGsonConverter(): GsonConverterFactory {
            if (gsonConverterFactory == null) {
                val gson: Gson = ValidityApplication.instance.getGson()

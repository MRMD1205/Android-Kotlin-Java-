package com.example.covidThreeStep.base
...
abstract class BaseActivity : AppCompatActivity(), BaseView, View.OnClickListener {
    ...
    open fun navigateToFragment(
        ...
        if (isAnimShow) fragmentTransaction.setCustomAnimations(R.anim.enter_from_right, R.anim.exit_to_left, R.anim.enter_from_left, R.anim.exit_to_right);
        fragmentTransaction.replace(R.id.frameContainer, fragment, tag) // Add Fragment container

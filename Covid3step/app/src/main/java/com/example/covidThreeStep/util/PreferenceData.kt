...
class PreferenceData(context: Context) {
    ...
    companion object {
        ...
        fun getImeiNumber(): String? {
            return CovidThreeStopApplication.instance.preferenceData?.getValueFromKey(PREF_IMEI)
        }
        ...
        fun isUserLoggedIn(): Boolean {
            return CovidThreeStopApplication.instance.preferenceData?.getValueBooleanFromKey(PREF_IS_USER_LOGGED_IN)!!
        }

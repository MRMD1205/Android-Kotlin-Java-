package com.tridhya.videoplay.enums;
...
import com.tridhya.videoplay.GPUFilter.filter.GlBitmapOverlaySample;
import com.tridhya.videoplay.R;
import com.tridhya.videoplay.interfaces.FilterAdjuster;
...
public enum FilterType {
    ...
    public static GlFilter createGlFilter(FilterType filterType, Context context) {
        switch (filterType) {
            ...
            case WATERMARK:
                return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.lookup_sample), GlWatermarkFilter.Position.RIGHT_BOTTOM);
            case WEAK_PIXEL:

...
import com.courtesycarsredhill.databinding.FragmentTermsnConditionBinding;
 ...
 * Use the {@link TermsnConditionFragment#newInstance} factory method to
...
public class TermsnConditionFragment extends BaseFragment {
    ...
    FragmentTermsnConditionBinding mBinding;
    private Boolean sosSuccess = false;


    public TermsnConditionFragment() {
     ...
     * @return A new instance of fragment TermsnConditionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TermsnConditionFragment newInstance(String param1, String param2) {
        TermsnConditionFragment fragment = new TermsnConditionFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setupToolBarWithMenu(mBinding.toolbar.toolbar, AppConstants.TNC);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_termsn_condition, container, false);
        mBinding.webView.getSettings().setJavaScriptEnabled(true);

        if (((BaseActivity) getContext()).isParent()) {
            mBinding.webView.loadUrl("file:///android_asset/terms-conditions-parent.html");
        } else {
            mBinding.webView.loadUrl("file:///android_asset/terms-conditions-driver.html");
        }

...
public abstract class JSONCallbackForRoute implements Callback<ResponseBody> {
    private Context context;
    private ProgressDialog dialog;

    public JSONCallbackForRoute(Context context) throws Exception {
        this(context, null);
    }

    public JSONCallbackForRoute(Context context, ProgressDialog dialog) throws Exception {
        this.dialog = dialog;

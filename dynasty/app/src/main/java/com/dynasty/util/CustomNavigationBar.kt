...
class CustomNavigationBar : BottomNavigationView {
    ...
    private fun init() {
        ...
        mPaint!!.color = mContext?.resources?.getColor(R.color.colorPrimary) ?: Color.WHITE
        setBackgroundColor(mContext?.resources?.getColor(R.color.colorPrimary) ?: Color.WHITE)
    }

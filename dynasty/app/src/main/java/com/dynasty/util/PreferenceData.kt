...
class PreferenceData(context: Context) {
    ...
    companion object {
        ...
        fun getImeiNumber(): String? {
            return BaseStructureApplication.instance.preferenceData?.getValueFromKey(PREF_IMEI)
        }
        ...
        fun isUserLoggedIn(): Boolean {
            return BaseStructureApplication.instance.preferenceData?.getValueBooleanFromKey(
        ...
        fun getDeviceToken(): String? {
            return BaseStructureApplication.instance.preferenceData?.getValueFromKey(
                PREF_DEVICE_TOKEN
            )
        }
        ...
        fun getFcmToken(): String? {
            return BaseStructureApplication.instance.preferenceData?.getValueFromKey(PREF_FCM_TOKEN)
        }
